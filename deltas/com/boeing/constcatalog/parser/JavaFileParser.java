...
public class JavaFileParser {
    ...
    private final MicroServiceDetector microServiceDetector = new MicroServiceDetector();
            ...
            if (parseResult.isSuccessful() && parseResult.getResult().isPresent()) {
                ...
                compilationUnit.accept(new VoidVisitorAdapter<Void>() {
                    ...
                    public void visit(FieldDeclaration field, Void arg) {
                        ...
                        // Catalog only public static final fields — private, protected,
                        // and package-private fields are internal to their class and
                        // should not be transformed or reported as unused.
    ...
    /**
     * Detect whether a Java file contains a microservice class.
     * Re-parses the file independently (same pattern as extractFqn).
     */
    public MicroServiceInfo detectMicroService(Path filePath) {
        try {
            ...
            if (parseResult.isSuccessful() && parseResult.getResult().isPresent()) {
                return microServiceDetector.detect(parseResult.getResult().get());
            }
        } catch (IOException e) {
            logger.error("Error reading file for microservice detection: {}", filePath, e);
        }
